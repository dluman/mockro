"""Pytest plugin that auto-activates feign mocks."""
...
import feign
from feign._core import get_registry


def pytest_configure(config: Any) -> None:  # noqa: ANN401
    """Install feign mocks before tests are collected."""
    feign.activate()


@pytest.fixture(autouse=True)
def _feign_registry_snapshot() -> Generator[None, None, None]:
